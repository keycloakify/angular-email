...
@Component({
  ...
  template: `
    <ng-email-html>
      ...
      <ng-email-body>
        <ng-email-section [sectionStyle]="main">
          <ng-email-container [containerStyle]="container">
            <ng-email-img
            ...
            <ng-email-heading [headingStyle]="heading">Here's what {{ authorName }} wrote</ng-email-heading>
            <ng-email-text [textStyle]="review">{{ reviewText }}</ng-email-text>
            <ng-email-text [textStyle]="paragraph">
            ...
            <ng-email-section [sectionStyle]="{ padding: '16px 0 20px' }">
              <ng-email-button
                [buttonStyle]="button"
            ...
            <ng-email-hr [hrStyle]="hr" />
            <ng-email-text [textStyle]="question">Common questions</ng-email-text>
            <ng-email-text>
              <ng-email-link
            ...
            <ng-email-hr [hrStyle]="hr" />
            <ng-email-text [textStyle]="footer">Airbnb, Inc., 888 Brannan St, San Francisco, CA 94103</ng-email-text>
            <ng-email-link
              href="https://airbnb.com"
              [linkStyle]="reportLink"
