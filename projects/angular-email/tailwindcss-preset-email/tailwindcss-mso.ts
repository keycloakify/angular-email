...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const mso = plugin.withOptions(function (options: any = {}) {
    ...
    matchUtilities(
      {
        'mso-ansi-font-size': (value) => ({
          'mso-ansi-font-size': value as string,
        }),
        'mso-bidi-font-size': (value) => ({
          'mso-bidi-font-size': value as string,
        }),
      },
      {
        values: {
    ...
    matchUtilities(
      {
        'mso-element-frame-width': (value) => ({
          'mso-element-frame-width': value as string,
        }),
        'mso-element-frame-height': (value) => ({
          'mso-element-frame-height': value as string,
        }),
      },
      {
        values: {
    ...
    matchUtilities(
      {
        'mso-element-left': (value) => ({
          'mso-element-left': value as string,
        }),
      },
      {
        values: {
    ...
    matchUtilities(
      {
        'mso-element-top': (value) => ({
          'mso-element-top': value as string,
        }),
      },
      {
        values: {
    ...
    matchUtilities(
      {
        'mso-line-height-alt': (value) => ({
          'mso-line-height-alt': value as string,
        }),
      },
      {
        values: {
    ...
    matchUtilities(
      {
        'mso-border-between-width': (value) => ({
          'mso-border-between-width': value as string,
        }),
        'mso-border-width-alt': (value) => ({
          'mso-border-width-alt': value as string,
        }),
        'mso-border-bottom-width-alt': (value) => ({
          'mso-border-bottom-width-alt': value as string,
        }),
        'mso-border-left-width-alt': (value) => ({
          'mso-border-left-width-alt': value as string,
        }),
        'mso-border-right-width-alt': (value) => ({
          'mso-border-right-width-alt': value as string,
        }),
        'mso-border-top-width-alt': (value) => ({
          'mso-border-top-width-alt': value as string,
        }),
      },
      {
        values: {
